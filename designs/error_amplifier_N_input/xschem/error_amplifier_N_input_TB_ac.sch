...
C {devices/launcher.sym} 160 -530 0 0 {name=h1
...
C {gf180/error_amplifier_N_input/xschem/error_amplifier_N_input.sym} 1030 -460 0 0 {name=x1}
...
write error_amplifier_N_input_TB_ac.raw
