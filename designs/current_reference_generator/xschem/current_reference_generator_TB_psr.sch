...
E {}
P 4 1 1160 -430 {}
N 1440 -260 1480 -260 {lab=VDD}
N 1440 -220 1480 -220 {lab=VSS}
N 1130 -180 1130 -140 {lab=VSS}
N 1130 -250 1130 -240 {lab=Vout}
N 1010 -430 1070 -430 {lab=#net1}
N 1010 -430 1010 -400 {lab=#net1}
N 940 -400 1010 -400 {lab=#net1}
N 1050 -460 1070 -460 {lab=Vrefp}
N 1160 -310 1160 -260 {lab=VSS}
N 1130 -310 1130 -250 {lab=Vout}
N 1050 -530 1050 -460 {lab=Vrefp}
N 1130 -550 1130 -510 {lab=VDD}
N 1310 -380 1520 -380 {lab=#net2}
N 1520 -380 1520 -290 {lab=#net2}
N 1310 -400 1560 -400 {lab=#net3}
N 1560 -400 1560 -290 {lab=#net3}
N 1310 -420 1600 -420 {lab=#net4}
N 1600 -420 1600 -290 {lab=#net4}
N 1310 -440 1640 -440 {lab=#net5}
N 1640 -440 1640 -290 {lab=#net5}
N 790 -440 830 -440 {
lab=Vout}
N 650 -490 830 -490 {
lab=Vin}
N 1310 -360 1350 -360 {lab=#net6}
N 1010 -460 1050 -460 {lab=Vrefp}
...
N 790 -440 790 -250 {lab=Vout}
N 790 -250 1130 -250 {lab=Vout}
C {res.sym} 1130 -210 0 0 {name=R1
value=600k
footprint=1206
device=resistor
m=1}
C {lab_pin.sym} 1130 -140 2 1 {name=p5 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1440 -260 2 1 {name=p3 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 1440 -220 2 1 {name=p6 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 900 -380 2 1 {name=p7 sig_type=std_logic lab=Vref}
C {lab_pin.sym} 900 -360 2 1 {name=p8 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 900 -340 2 1 {name=p9 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 650 -490 2 1 {name=p10 sig_type=std_logic lab=Vin}
C {lab_pin.sym} 1160 -260 0 1 {name=p11 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1050 -530 0 1 {name=p17 sig_type=std_logic lab=Vrefp}
C {lab_pin.sym} 1130 -550 0 1 {name=p18 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 1130 -280 2 1 {name=p1 sig_type=std_logic lab=Vout}
C {noconn.sym} 1350 -360 2 0 {name=l8}
C {gf180/current_reference_second_stage/xschem/current_reference_second_stage.sym} 1180 -400 0 0 {name=x2}
C {gf180/current_reference_load/xschem/current_reference_load.sym} 1580 -240 0 0 {name=x3}
C {gf180/error_amplifier_N_input/xschem/error_amplifier_N_input.sym} 920 -460 0 0 {name=x1}
...
write current_reference_generator_TB_psr.raw
