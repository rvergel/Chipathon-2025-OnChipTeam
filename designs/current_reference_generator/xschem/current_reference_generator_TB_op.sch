...
S {}
E {}
N 930 -270 1030 -270 {lab=#net1}
N 1030 -270 1030 -210 {lab=#net1}
N 930 -290 1070 -290 {lab=#net2}
N 1070 -290 1070 -210 {lab=#net2}
N 930 -310 1110 -310 {lab=#net3}
N 1110 -310 1110 -210 {lab=#net3}
N 930 -330 1150 -330 {lab=#net4}
N 1150 -330 1150 -210 {lab=#net4}
N 590 -360 630 -360 {lab=Vref}
N 750 -440 750 -400 {lab=VDD}
N 950 -180 990 -180 {lab=VDD}
N 950 -140 990 -140 {lab=VSS}
N 750 -100 750 -60 {lab=VSS}
N 750 -200 750 -160 {lab=#net5}
N 780 -200 780 -160 {lab=VSS}
N 930 -250 970 -250 {lab=#net6}
N 930 -350 970 -350 {lab=#net7}
...
C {devices/lab_wire.sym} 780 -160 2 0 {name=p1 sig_type=std_logic lab=VSS}
C {res.sym} 750 -130 0 0 {name=R1
value=600k
footprint=1206
device=resistor
m=1}
C {lab_pin.sym} 750 -60 2 1 {name=p5 sig_type=std_logic lab=VSS}
...
C {lab_pin.sym} 950 -180 2 1 {name=p3 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 950 -140 2 1 {name=p6 sig_type=std_logic lab=VSS}
C {noconn.sym} 970 -250 2 0 {name=l8}
C {noconn.sym} 970 -350 2 0 {name=l9}
C {gf180/current_reference_load/xschem/current_reference_load.sym} 1090 -160 0 0 {name=x3}
...
write current_reference_generator_TB_op.raw

.endc
"}
C {gf180/current_reference_generator/xschem/current_reference_generator.sym} 780 -300 0 0 {name=x1}
